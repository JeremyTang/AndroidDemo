...
public class FileDirFragment extends Fragment implements FileUtil.Defs {
	...
	public final static String USB_STROGE_PATH = "/storage/usbcard";//add by wuzhaojun to fix bug#3446:Press the return key to quit the file manager
            ...
            public void onClick(View v) {
                if (CURRENTPATH != null && !TextUtils.isEmpty(FileUtil.PATH_SDCARD_3)
                    ...
                    if (CURRENTPATH.equals(FileUtil.PATH_SDCARD_3)) {
                    	...
                    	if(CURRENTPATH.equals("/storage/usbcard"))
                    	{
                    		showToast(getString(R.string.u_disk_rootpath));
                    	}
                    	else if(CURRENTPATH.equals("/storage/sdcard_ext"))
                    	{
...
//                }
                ...
                if( CURRENTPATH.equals("/storage/usbcard") || CURRENTPATH.equals("/storage/sdcard_ext") )
                {
