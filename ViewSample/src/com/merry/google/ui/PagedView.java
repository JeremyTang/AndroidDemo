...
import com.merry.google.R;
import com.merry.google.util.LauncherAnimUtils;
...
public abstract class PagedView extends ViewGroup implements
	...
	protected int getChildWidth(int index) {
		...
		if (child == null) {
			// when x < cellX or x >= cellX + cellHSpan or y < cellY or y >
			// cellY + cellVSpan
	...
	protected String getCurrentPageDescription() {
		// tangjingliang
		return String.format(getContext().getString(R.string.app_default),
